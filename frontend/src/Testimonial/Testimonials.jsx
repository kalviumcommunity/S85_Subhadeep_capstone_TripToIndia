    ...
    return (
        <Slider {...settings}>
            <div className="testimonial py-4 px-3">
                <p>Planning our dream getaway was a breeze, thanks to TripToIndia's website!
                ...
                <div className="d-flex align-items-center gap-4 mt-3">
                    <img src={ava01} className="w-16 h-16 object-cover rounded-full border border-gray-300" alt="" />
                    <div >
            ...
            <div className="testimonial py-4 px-3">
                <p>Our dream getaway planning became a delight, all thanks to TripToIndia's
                ...
                <div className="d-flex align-items-center gap-4 mt-3">
                    <img src={ava02} className="w-16 h-16 object-cover rounded-full border border-gray-300" alt="" />
                    <div >
            ...
            <p>Planning our dream getaway was a breeze, thanks to TripToIndia's website!
                     ...
                     From the comprehensive guidance on the Dodecanese Greek Islands
                      ...
                      closer to paradise.</p>
                <div className="d-flex align-items-center gap-4 mt-3">
                    <img src={ava03} className="w-16 h-16 object-cover rounded-full border border-gray-300" alt="" />
                    <div >
            ...
            <p>Our dream getaway planning became a delight, all thanks to TripToIndia's
                ...
                <div className="d-flex align-items-center gap-4 mt-3">
                    <img src={pic1} className="w-16 h-16 object-cover rounded-full border border-gray-300" alt="" />
                    <div >
